...
export function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    const endpoint =
      role === "admin" ? `${BASE_URL}/admin/login` : `${BASE_URL}/login`;
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg shadow-inner text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
            >
